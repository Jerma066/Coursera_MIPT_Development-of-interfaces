...
assert.equal(addTime(4, 40, 0), '04:40', 'При добавлении 0 мин. к 4:40 получится 04:40');
assert.equal(addTime(15, 0, 720), '03:00', 'При добавлении 720 мин. к 23:01 получится 03:00');
